...
┌─ Параметры ──────────────────────────────────────┐
│ Bearer-токен:  ••••••••••••••••••••              │
│ Имя блога:     xcharodeykax                      │
│ Папка:         C:\...\downloads        [Обзор…] │
│ Типы медиа:    [✓] Изображения  [✓] Видео        │
│ Потоков:       4   [✓] Пропускать уже скачанные  │
└──────────────────────────────────────────────────┘
                          [Старт]  [Стоп]
   18 / 240  (7%)   ████████░░░░░░░░░░░░░░░░░░░░░
┌─ Лог ────────────────────────────────────────────┐
│ [18/240] a8b3c1.jpg — скачан                     │
│ [19/240] a8b3c2.jpg — уже есть                   │
│ ...                                              │
└──────────────────────────────────────────────────┘
```
